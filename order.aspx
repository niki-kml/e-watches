<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="order.aspx.cs" Inherits="e_Watch.order" %>
	...
	<div id="PageContainer" class="is-moved-by-drawer">
		...
		<!-- Main Content -->
			...
			<div class="breadcrumb-wrapper">
				...
				<h1 class="section-header__title">Place your order</h1>
			</div>
			
                    <center>
            <div id="bodyBox">
			<h3>Place your order</h3>
            <asp:TextBox ID="txtSubject" runat="server" Text="Name and Surname" Width="300px" ForeColor="Silver"></asp:TextBox> <br /><br />
			<asp:TextBox ID="txtEmail" Text="Cell Number" runat="server" Width="300px" ForeColor="Silver"></asp:TextBox><br /><br />
			<asp:TextBox ID="txtComments" Text="Comments" runat="server" Width="300px" ForeColor="Silver"></asp:TextBox><br /><br />
			<asp:TextBox ID="txtName" Text="Email Address" runat="server" Width="300px" ForeColor="Silver"></asp:TextBox><br />
			<br />
