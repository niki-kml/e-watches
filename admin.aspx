<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin.aspx.cs" Inherits="e_Watch.admin" %>
...
<td runat="server" />
                        ...
                        <%--<InsertItemTemplate>
                            <td runat="server" style="">Id:
                                <asp:TextBox ID="IdTextBox" runat="server" Text='<%# Bind("Id") %>' />
                                <br />Image:
								<asp:Image ID="Image2" ImageUrl='<%# Bind("Image") %>' runat="server" Width="150" />
                    ...
                    <asp:DetailsView ID="DetailsView1" runat="server" Height="50px" Width="125px" AutoGenerateRows="False" DataKeyNames="Id" DataSourceID="ObjectDataSource1" DefaultMode="Insert">
                        <Fields>
                            ...
                            <asp:TemplateField HeaderText="Image" SortExpression="Image">
                                ...
                                <InsertItemTemplate>
                                    <asp:Image ID="Image3" ImageUrl='<%# Bind("Image") %>' runat="server" Width="160px" />
                    ...
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="DeleteW" InsertMethod="wInsertW" SelectMethod="GetWList" TypeName="wDBSQLProvider" UpdateMethod="UpdateW">
                        <DeleteParameters>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [tbl_Pro]"></asp:SqlDataSource>
		...
		<footer class="site-footer">       
			<div class="grid__item footer_newsletter">
				<div class="wrapper">
					<h3><i class="fa fa-envelope"></i> Make sure you don't miss interesting happenings by joining our newsletter programinput type="email" value="" placeholder="Enter your email here ..." name="EMAIL" id="mail" class="input-group-field" aria-label="email@example.com">
						<span class="input-group-btn">
