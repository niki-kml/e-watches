<%@ Page Title="Home Page" Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="e_Watch._Default" %>
...
<head>
	...
	<meta charset="utf-8">
	<title>Home Market - Responsive HTML5 theme – Orange version</title>
	<!-- Font ================================================== -->
	...
	<meta property="og:site_name" content="Home Market Orange">
	...
	<link href="assets/css/home_market.style4.scss.css" rel="stylesheet" type="text/css" media="all">
...
<%--				<ul class="mobile-nav__sublist">
					...
					<li class="mobile-nav__item ">
					<a href="./collection.html" class="mobile-nav__link">Camera</a>
					</li>
					<li class="mobile-nav__item ">
			...
			<ul class="mobile-nav__sublist megamenu__dropdown mobile_megamenu_1">
				...
				<ul>
					...
					<li class="list-unstyled nav-sub-mega">
					<a href="./collection.htmll">All Products</a>
					</li>
					<li class="list-unstyled nav-sub-mega">
					<a href="./collection.htmls">About us</a>
					</li>
					<li class="list-unstyled nav-sub-mega">
				...
				<div id="main-header" class="grid--full grid--table">
					<div class="grid__item small--one-whole medium--one-whole two-eighths">
						...
						<a href="./index.html" itemprop="url" class="site-header__logo-link">
							<img src="./assets/images/logo4.png" alt="Home Market Red" itemprop="logo">
						</a>
						</h1>
					</div>
				...
				<div class="medium-down--hide" style="float: left; width: 100%; position: relative;">
					...
					<ul class="site-nav" id="AccessibleNav">
						<li class="site-nav--active">
							<a href="./Default.aspx" class="site-nav__link">
								<span>Home</span>
							</a>
						</li>
						<li class="site-nav--has-dropdown" aria-haspopup="true">
							<a href="./About.aspx" class="site-nav__link">
								<span>About Us</span>
						...
						<li class="mega-menu site-nav--has-dropdown" aria-haspopup="true">
							<a href="./shop.aspx" class="site-nav__link">
								<span>Shop</span>
								<span class="icon icon-arrow-down" aria-hidden="true"></span>
						...
						<li>
							<a href="./Contact.aspx" class="site-nav__link">
						 ...
						 <% if (User.IsInRole ("Admin"))
                                { 
                                    %>
                                    <li><a href="admin.aspx" class="site-nav__link">Admin</a></li>
                                    <%
                                }
                             %>
						<%--<li>
		...
		<main class="main-content">	
			<div class="wrapper">
				<div id="top-home-blocks" class="grid--full grid--table">					
					<div class="grid__item six-eighths main-slideshow">
						<div class="main_slideshow_wrapper">
							<div id="slider" class="flexslider">
								<ul class="slides">
									<li>
										<a href="./collection.html" onclick="location.href = './collection.html'"><img src="assets/images/demo1_885x413(2).jpg" alt="" /></a>
									</li>
									<li>
										<a href="./collection.html" onclick="location.href = './collection.html'"><img src="assets/images/demo1_885x413(2)" alt="" /></a>
									</li>
									<li>
										<a href="./collection.html" onclick="location.href = './collection.html'"><img src="assets/images/demo1_885x413(2).jpg" alt="" /></a>
									</li>
					...
					<div class="grid__item two-eighths top-offer">
						<div class="top-offer-inner">
							<div class="top-offer-title"><span>TOP OFFER</span></div>
							<div class="top-offer-products in-desktop">
								<div class="product-item-wrapper">
									...
									<div class="grid__item">
												<div class="grid__item_wrapper">
													<div class="grid__image product-image">
														<a href="./product.html">
														<img src="assets/images/demo1_qs2_100x100.jpg" alt="Consequuntur magni dolores">
														</a>
														<div class="quickview">
															<div class="product-ajax-cart hidden-xs hidden-sm">
																<div data-handle="consequuntur-magni-dolores" class="quick_shop-div">
									...
									<div class="grid__item">
												<div class="grid__item_wrapper">
													<div class="grid__image product-image">
														<a href="./product.html">
														<img src="assets/images/demo1_qs3_100x100.jpg" alt="Consequuntur magni dolores">
														</a>
														<div class="quickview">
															<div class="product-ajax-cart hidden-xs hidden-sm">
																<div data-handle="consequuntur-magni-dolores" class="quick_shop-div">
								...
								<%--<div class="product-item-wrapper">
									<div class="grid__item">
												<div class="grid__item_wrapper">
													<div class="grid__image product-image">
														<a href="./product.html">
														<img src="assets/images/demo1_qs4_100x100.jpg" alt="Consequuntur magni dolores">
														</a>
														<div class="quickview">
															<div class="product-ajax-cart hidden-xs hidden-sm">
																<div data-handle="consequuntur-magni-dolores" class="quick_shop-div">
									...
									<div class="grid__item">
												<div class="grid__item_wrapper">
													<div class="grid__image product-image">
														<a href="./product.html">
														<img src="assets/images/demo1_qs5_100x100.jpg" alt="Consequuntur magni dolores">
														</a>
														<div class="quickview">
															<div class="product-ajax-cart hidden-xs hidden-sm">
																<div data-handle="consequuntur-magni-dolores" class="quick_shop-div">
				...
				<div id="featured_collection" class="featured-collection grid--full grid--table grid-block-full">
					<div class="featured-collection-inner">
						<div class="home-collection-wrapper">
							<h1 class="feature-title"><span>Featured Collections</span></h1>
							<div class="home-collection-inner">
								<div class="coll-items">
									<a href="./collection.html"><img class="coll-img" src="assets/images/coll1.jpg" alt="Diamond Classics"></a>
									<div class="detail">
										<div class="coll-name">
											<a href="./collection.html">Diamond Classics</a>
										</div>
										<div class="coll-number">
											50 items
										</div>
									</div>
								</div>
								<div class="coll-items">
									<a href="./collection.html"><img class="coll-img" src="assets/images/coll2.jpg" alt="Diamond Classics"></a>
									<div class="detail">
										<div class="coll-name">
											<a href="./collection.html">Diamond Classics</a>
										</div>
								...
								<div class="coll-items">
									<a href="./collection.html"><img class="coll-img" src="assets/images/coll3.jpg" alt="Diamond Classics"></a>
									<div class="detail">
										<div class="coll-name">
											<a href="./collection.html">Diamond Classics</a>
										</div>
								...
								<div class="coll-items">
									<a href="./collection.html"><img class="coll-img" src="assets/images/coll4.jpg" alt="Diamond Classics"></a>
									<div class="detail">
										<div class="coll-name">
											<a href="./collection.html">Diamond Classics</a>
										</div>
								...
								<div class="coll-items">
									<a href="./collection.html"><img class="coll-img" src="assets/images/coll5.jpg" alt="Diamond Classics"></a>
									<div class="detail">
										<div class="coll-name">
											<a href="./collection.html">Diamond Classics</a>
										</div>
								...
								<div class="coll-items">
									<a href="./collection.html"><img class="coll-img" src="assets/images/coll6.jpg" alt="Diamond Classics"></a>
									<div class="detail">
										<div class="coll-name">
											<a href="./collection.html">Diamond Classics</a>
										</div>
				...
				<div class="group_blocks grid--full grid--table grid-block-full">
					<div class="grid__item two-eighths latest_block">
						<div class="latest-inner">
							<div class="latest-title"><span>LATEST PRODUCTS</span></div>
							<div class="latest-products group_blocks_products">
								<div class="product-item-wrapper">
									<div class="grid__item">
												<div class="grid__item_wrapper">
													<div class="grid__image product-image">
					...
					<div class="grid__item four-eighths special">
						<div class="special-inner">
							<div class="special-title"><span>SPECIAL OFFERS</span></div>
							<div class="special-products group_blocks_products">
								<div class="product-item-wrapper">
									<div class="grid__item">
										<div class="grid__item_wrapper">
											<div class="grid__image product-image grid__item one-half">
												<a href="./product.html">
													<img src="assets/images/home4_spec1_340x340.jpg" alt="Demo Product Sample">
												</a>
												<div class="quickview">
													<div class="product-ajax-cart hidden-xs hidden-sm">
														<div data-handle="combined-with-a-handful-of-model" class="quick_shop-div">
															<a href="#quick-shop-modal" class="btn quick_shop">
															<i class="fa fa-eye" title="Quick View"></i>																													
															</a>
														</div>
											...
											<div class="grid__info grid__item one-half">
												<div class="rating-star">
													<span class="spr-badge" id="spr_badge_4398351430" data-rating="0.0">
												...
												<p class="product-price">
													<strong>On Sale</strong> from <span class="money" data-currency-usd="$80.00">$80.00</span>
													<span class="visually-hidden">Regular price</span>
													<s><span class="money" data-currency-usd="$90.00">$90.00</span></s>
												</p>
												<p class="product-desc">
													Quisque vel enim quis purus ultrices consequat, sed tincidunt massa blandit ipsum interdum tristique cras dictum, lacus eu molestie elementum...
												</p>
								...
								<%--<div class="product-item-wrapper">
									<div class="grid__item">
										<div class="grid__item_wrapper">
											<div class="grid__image product-image grid__item one-half">
												<a href="./product.html">
													<img src="assets/images/home4_spec2_340x340.jpg" alt="Demo Product Sample">
												</a>
												<div class="quickview">
													<div class="product-ajax-cart hidden-xs hidden-sm">
														<div data-handle="combined-with-a-handful-of-model" class="quick_shop-div">
					...
					<div class="grid__item two-eighths best-seller">
						<div class="best-seller-inner">
							<div class="best-seller-title"><span>OUR SUGGESTS</span></div>
							<div class="best-seller-products group_blocks_products">
								<div class="product-item-wrapper">
									<div class="grid__item">
												<div class="grid__item_wrapper">
													<div class="grid__image product-image">
				...
				<div id="top_banner" class="top-banner-wrapper grid--full grid--table grid-block-full">
					<div class="top-banner-inner">
						<div class="top-banner-element grid--full one-third">
							<div class="inner">
								<a href="./collection.html"><img class="top-banner-img" src="assets/images/home4_topbanner_img1.jpg" alt="top banner 1"></a>
							</div>
						</div>
						<div class="top-banner-element grid--full one-third">
							<div class="inner">
								<a href="./collection.html"><img class="top-banner-img" src="assets/images/home4_topbanner_img2.jpg" alt="top banner 2"></a>
							</div>
						</div>
						<div class="top-banner-element grid--full one-third">
							<div class="inner">
								<a href="./collection.html"><img class="top-banner-img" src="assets/images/home4_topbanner_img3.jpg" alt="top banner 3"></a>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="home-tabs-inner">
						<div id="tabs-product">
							<ul class="nav nav-tabs tabs-left sideways">
								<li class="tab1"><a href="#tab1" data-toggle="tab">New Arrivals</a></li>
								<li class="tab2"><a href="#tab2" data-toggle="tab">Best Sellers</a></li>
								<li class="tab3"><a href="#tab3" data-toggle="tab">Featured Products</a></li>
							</ul>
							<div class="tab-panel active" id="tab1">
								<div class="fi-item grid__item one-fifth">
									<div class="grid__item">
												<div class="grid__item_wrapper">
													<div class="grid__image product-image">
														<a href="./product.html">
						...
						<script>
							$('#tabs-product').easytabs({animationSpeed: 'fast', updateHash: false});
						</script>
					</div>
				</div>--%>

				<%--<div id="featured_brands" class="featured-brand grid--full grid--table grid-block-full">
					<div class="featured-brand-inner">
						<h1 class="brands-title"><span>FEATURED BRANDS</span></h1>
				...
				<div class="wrapper">
					<div class="grid">
						<div class="grid__item footer-copyright one-half small--one-whole medium--one-whole small--text-center">
							<p>
								© 2016 Home Market - Orange. All rights Reserved
							</p>
						</div>
