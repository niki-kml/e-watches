<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="shop.aspx.cs" Inherits="e_Watch.shop" %>
                       ...
                       <%-- <InsertItemTemplate>
                        ...
                        <ItemTemplate>
                            <td runat="server" style="">                                
                                <br />
								<asp:Image ID="Image1" ImageUrl='<%# Eval("Image") %>' runat="server" Width="160px" />
                                <br />R
                                <asp:Label ID="PriceLabel" runat="server" Text='<%# Eval("Price") %>' />
                                <br />
								<div class="grid__item small--one-whole two-eighths medium-down--hide">
								<asp:HyperLink runat="server" NavigateUrl="~/order.aspx">Order</asp:HyperLink>
                                    <%--<asp:Button ID="Button3" runat="server" Text="Order" /></span>		--%>			
								</div>
							</li>
					</div>
								<br />
